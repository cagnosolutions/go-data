...
// // stole from here to do a quick go port
//
// /*
// var smaz_cb = [241]string{
...
// }
//
// func smaz_compress(in *string, inlen int, out *string, outlen int) error {
// 	var h1, h2, h3 uint
// 	var verblen = 0
// 	var _outlen = outlen
// 	var verb [256]string
...
// }
//
// // func smaz_decompress(char *in, int inlen, char *out, int outlen) {
// // 	unsigned
// // 	char * c = (unsigned
// // 	char *) in;
// // 	char * _out = out;
